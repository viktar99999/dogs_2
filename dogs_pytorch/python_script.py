...
regressor = RandomForestRegressor(n_estimators = 100, max_features = 'log2',
    max_depth = 1, min_samples_split = 61, min_samples_leaf = 122, n_jobs = 2, random_state = 8001)
...
print(X_test)
print(y_test)
X = torch.randn(BATCH_SIZE_LR, 16)
X_t = X.reshape(16, 16)
...
print(X_test)
print(y_test)
X = torch.randn(BATCH_SIZE_LR_1, 16)
X_t = X.reshape(16, 16)
y = torch.Tensor([[1.0], [0.0], [0.0], [1.0], [1.0],
    [1.0], [0.0], [0.0], [1.0], [1.0],
    [1.0], [0.0], [0.0], [1.0], [1.0],
